                ...
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item dropdown mr-3">
                        ...
                        <div class="p  dropdown-content dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:black">
                            <a class="dropdown-item " style="color:white;font-size:14px" href="{{ route('product-tshirt') }}">T'shirt</a>
                            <a class=" dropdown-item" style="color:white;font-size:14px" href="{{ route('product-sweater') }}">Crewneck</a>
                        </div>
                    </li>
